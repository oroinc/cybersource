...
class PaymentActionOptionProvider extends AbstractPaymentActionOptionProvider
{
    ...
    public function getPurchaseOptions(CyberSourceConfigInterface $config, PaymentTransaction $transaction)
    {
        ...
        $processingInfoArr = [
            'ignoreAvsResult' => $config->getIgnoreAvs(),
            'ignoreCvResult' => $config->getIgnoreCvn()
        ];
        ...
        return [
            ...
            'processingInformation' => new Ptsv2paymentsProcessingInformationAuthorizationOptions($processingInfoArr),
