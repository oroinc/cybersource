...
Feature: Cancel authorization
  ...
  Scenario: Failed cancel action for payment authorization transaction
    ...
    Then I should see "Cancel Authorized Payment" in the "UiWindow Title" element
    And I should see "The $13.00 authorized payment will be canceled. Are you sure you want to continue?"
    When I click "Yes, Cancel Authorized Payment" in modal window
