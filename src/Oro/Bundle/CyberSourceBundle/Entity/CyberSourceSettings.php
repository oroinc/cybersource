...
class CyberSourceSettings extends Transport
{
     ...
     * @var bool
     *
     * @ORM\Column(name="cbs_ignore_avs", type="boolean", options={"default"=false})
     */
    private $cbsIgnoreAvs = false;

    /**
     * @var bool
     *
     * @ORM\Column(name="cbs_ignore_cvn", type="boolean", options={"default"=false})
     */
    private $cbsIgnoreCvn = false;

    /**
     * @var bool
     *
     * @ORM\Column(name="cbs_auth_reversal", type="boolean", options={"default"=false})
     */
    private $cbsAuthReversal = false;

    /**
     * @var bool
     *
     * @ORM\Column(name="cbs_display_errors", type="boolean", options={"default"=false})
     */
    private $cbsDisplayErrors = false;
        ...
        if (null === $this->settings) {
            $this->settings = new ParameterBag(
                [
                    ...
                    self::METHOD_KEY => $this->getCbsMethod(),
                    self::IGNORE_AVS_KEY => $this->getCbsIgnoreAvs(),
                    self::IGNORE_CVN_KEY => $this->getCbsIgnoreCvn(),
                    self::AUTH_REVERSAL_KEY => $this->getCbsAuthReversal(),
                    self::DISPLAY_ERRORS_KEY => $this->getCbsDisplayErrors(),
                ]
            );
        }
     ...
     * @return bool
     */
    public function getCbsIgnoreAvs(): bool
    {
        return $this->cbsIgnoreAvs;
    }

    /**
     * @param bool $cbsIgnoreAvs
     *
     * @return CyberSourceSettings
     */
    public function setCbsIgnoreAvs(bool $cbsIgnoreAvs): CyberSourceSettings
    {
        $this->cbsIgnoreAvs = $cbsIgnoreAvs;
     ...
     * @return bool
     */
    public function getCbsIgnoreCvn(): bool
    {
        return $this->cbsIgnoreCvn;
    }

    /**
     * @param bool $cbsIgnoreCvn
     *
     * @return CyberSourceSettings
     */
    public function setCbsIgnoreCvn(bool $cbsIgnoreCvn): CyberSourceSettings
    {
        $this->cbsIgnoreCvn = $cbsIgnoreCvn;
     ...
     * @return bool
     */
    public function getCbsAuthReversal(): bool
    {
        return $this->cbsAuthReversal;
    }

    /**
     * @param bool $cbsAuthReversal
     *
     * @return CyberSourceSettings
     */
    public function setCbsAuthReversal(bool $cbsAuthReversal): CyberSourceSettings
    {
        $this->cbsAuthReversal = $cbsAuthReversal;
     ...
     * @return bool
     */
    public function getCbsDisplayErrors(): bool
    {
        return $this->cbsDisplayErrors;
    }

    /**
     * @param bool $cbsDisplayErrors
     *
     * @return CyberSourceSettings
     */
    public function setCbsDisplayErrors(bool $cbsDisplayErrors): CyberSourceSettings
    {
        $this->cbsDisplayErrors = $cbsDisplayErrors;
